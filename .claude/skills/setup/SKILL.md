...
Tell the user to run `bash nanoclaw.sh` in their terminal. That script handles the full end-to-end setup — dependencies, container image, Anthropic-compatible credential, service, first agent, and optional channel wiring.
